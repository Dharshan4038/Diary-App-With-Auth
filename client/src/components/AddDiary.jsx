...
export const AddDiary = ({postTitle,setPostTitle,postBody,setPostBody,handleAddSubmit}) => {
    ...
    return (
        <div className='addpost'>
            <form onSubmit={(event)=>{
                ...
                <button type="submit" className="btn btn-primary mx-5 mt-3 btn-lg">Post</button>
            </form>
        </div>
    )
}
